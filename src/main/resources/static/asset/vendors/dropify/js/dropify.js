...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        maxFileSize: 0,
        messages: {
            'default': 'Drag and drop a fileUpload here or click',
            'replace': 'Drag and drop or click to replace',
            'remove':  'Remove',
            'error':   'Sorry, this fileUpload is too large'
        },
        tpl: {
            wrap:        '<div class="dropify-wrapper"></div>',
            message:     '<div class="dropify-message"><span class="fileUpload-icon" /> <p>{{ default }}</p></div>',
            preview:     '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
            filename:    '<p class="dropify-filename"><span class="fileUpload-icon"></span> <span class="dropify-filename-inner"></span></p>',
...
/**
 * Read the fileUpload url using FileReader
 *
 * @param  {Object} input
 */
...
Dropify.prototype.setPreview = function(src)
{
    ...
    if (this.isImage() === true) {
        ...
        $('<i />').attr('class', 'dropify-font-fileUpload').appendTo(render);
...
/**
 * Test if the fileUpload is an image
 *
 * @return {Boolean}
 */
